...
const GameInviteOrParticipation = ({isGameStart, setIsGameStart, member}) => {
    ...
    return (
        <div className='flex flex-col w-[100vw] h-[100vh] justify-center items-center gap-5'>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <button className="w-60 h-16 bg-purple-600 rounded text-white transition-all duration-200 hover:opacity-70"
            ...
            ></input>
            <button className='bg-purple-200 w-20 h-16
